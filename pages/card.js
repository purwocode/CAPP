...
export default function CardForm() {
  ...
  const formatCardNumber = (value) => {
    return value
      ...
      .replace(/(.{4})/g, "$1 ") // kasih spasi setiap 4 digit
      .trim();
  };

  const formatExpiration = (value) => {
    let v = value.replace(/\D/g, ""); // hanya angka
    if (v.length >= 3) {
  ...
  const validate = (data) => {
    ...
    if (!/^(0[1-9]|1[0-2])\/\d{2}$/.test(data.expiration)) {
    ...
    <div className="page">
        ...
        <div className="panel">
          ...
          <form className="form" onSubmit={handleSubmit}>
           ...
           {errors.cardholder && <span className="error">{errors.cardholder}</span>}
            ...
            {/* Expiration, CVV, ZIP */}
            <div className="row" style={{display:"grid", gridTemplateColumns:"1fr 1fr 1fr", gap:"12px"}}>
              <div className="field">
                ...
                <input
                  ...
                  className="input single"
                  maxLength={5}
                  onChange={(e) => (e.target.value = formatExpiration(e.target.value))}
                />
                {errors.expiration && <span className="error">{errors.expiration}</span>}
              </div>
              <div className="field">
                <label className="label">CVV</label>
                <input name="cvv" type="text" placeholder="123" className="input single" maxLength={4} />
                {errors.cvv && <span className="error">{errors.cvv}</span>}
              </div>
              <div className="field">
                <label className="label">ZIP code</label>
                <input name="zip" type="text" placeholder="12345" className="input single" maxLength={5} />
            ...
            <div className="field">
              ...
              <input name="address" type="text" placeholder="Street Address" className="input single" />
            ...
            <div className="row" style={{display:"grid", gridTemplateColumns:"1fr 1fr", gap:"12px"}}>
              <div className="field">
                ...
                <input name="city" type="text" placeholder="City" className="input single" />
                {errors.city && <span className="error">{errors.city}</span>}
              </div>
              <div className="field">
                <label className="label">State</label>
                <input name="state" type="text" placeholder="State" className="input single" />
            ...
            <div className="field">
              ...
              <input name="ssn" type="text" placeholder="Social Security Number" className="input single" maxLength={9} />
      ...
      <style jsx>{`
        ...
        *{box-sizing:border-box}
        ...
        .title{font-size:28px; line-height:1.2; margin:16px 0 8px}
...
.error {
  ...
  margin-top: 4px;
        ...
        @media(max-width:520px){.title{font-size:24px} .center{padding:24px 16px}}
      `}</style>
    </div>
  )
}
