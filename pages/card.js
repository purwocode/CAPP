        ...
        <div className="panel">
          ...
          <form className="form">
            ...
            <div className="field">
              ...
              <input type="text" className="input single" />
            </div>

            {/* Card Number */}
            <div className="field">
              <label className="label">Debit card number</label>
              <input type="text" placeholder="0000 0000 0000 0000" className="input single" />
            </div>
            ...
            <div className="row" style={{display:"grid", gridTemplateColumns:"1fr 1fr 1fr", gap:"12px"}}>
              <div className="field">
                ...
                <input type="text" placeholder="MM/YY" className="input single" />
              </div>
              <div className="field">
                <label className="label">CVV</label>
                <input type="text" placeholder="123" className="input single" />
              </div>
              <div className="field">
                <label className="label">ZIP code</label>
                <input type="text" placeholder="12345" className="input single" />
              </div>
            </div>
            ...
            <div className="field">
              ...
              <input type="text" placeholder="Street Address" className="input single" />
            </div>
            ...
            <div className="row" style={{display:"grid", gridTemplateColumns:"1fr 1fr", gap:"12px"}}>
              <div className="field">
                ...
                <input type="text" placeholder="City" className="input single" />
              </div>
              <div className="field">
...
.input {
  ...
  width: 100%;
        ...
        .input.single{border-radius:5px; width:100%; border: 2px solid rgb(244, 244, 244);}
